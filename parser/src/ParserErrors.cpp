...
std::unordered_map<error_id, std::string> error_messages = {
    ...
    {error_id::E005, "Type '{:s}' does not exist."},
    {error_id::E006, "Record field names must be unique in the record"},
    {error_id::E007, ""},
    {error_id::E008, ""},
    {error_id::E009, "Procedure identifiers must be unique in the procedure"},
    ...
    {error_id::E013, "Comparison operators require the same type for both args, got '{:s}' and '{:s}'."},
    {error_id::E014, "Boolean operators operate only on 'BOOLEAN' but got '{:s}'."},
    {error_id::E015, "Undeclared identifier '{:s}'."},
    {error_id::E016, "Array selector can only be used on ARRAY types ubt the type is '{:s}'."},
    ...
    {error_id::E020, "Number of actual parameters ({:d}) and formal parameters ({:d}) of function '{:s}' must match."},
    {error_id::E021, "Parameter Type mismatch. Expected '{:s}' but got '{:s}'."},
    {error_id::E022, "Parameter '{:s}' is passed by reference but the actual value is not assignable."},
