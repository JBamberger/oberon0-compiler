...
MemberLayout<VariableDeclarationNode>& BlockNode::getVariables() { return variables_; }
...
const MemberLayout<VariableDeclarationNode>& BlockNode::getVariables() const { return variables_; }
